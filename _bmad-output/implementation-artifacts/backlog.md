...
| 2026-07-07 | walkway-variants | OpenSkyscraper docs | review-deferral | P3 | — | — | open | **Gated — canon question, verify before touching the engine.** The TDT stairs table's type field supports 2- and 3-story stairs/escalators (`docs/canon/tdt-format.md` §8), but neither source says the shipped game ever creates them; our canon (CLAUDE.md) holds walkways to fixed two-floor flights. Party verdict (2026-07-07): format allowance ≠ game behavior — HOLD; verify against the real game (play/screenshots) before any `maxSpanFor` change. |
| 2026-07-07 | service-capacity-10 | OpenSkyscraper docs | feature-request | P1 | — | — | open | **Ready — user-ratified 2026-07-07; ships as its OWN PR right after the pacing PR merges.** `TRANSPORT_CAPACITY.elevatorService` 16 → **10** per the decoded capacity byte in dfloer's spec (42/21/10; the 42 and 21 match our already-sourced numbers — our 16 was uncited). Update dispatch/congestion/housekeeping tests, patch bump, honest release note ("canon fix: service elevators carry 10, as in 1994"). |
