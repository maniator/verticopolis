...
4. `Priority` is the do-first order (impact × effort × risk, and whether the
   ...
   spec. Rows are kept sorted P1 → P3, and **within P3, _ready_ cheap fixes come
   before _gated_ items** (blocked on profiling / a spec / watch-only) so nobody
   burns a session grabbing a blocked "easy P3."
