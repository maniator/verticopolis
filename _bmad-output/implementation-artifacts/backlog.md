...
2. **`finish()` tripwire test (GH #302):** the attendance tally has one decrement path
...
3. **Cinema occupancy display** ([[cinema-occupancy-display]], GH #354): re-scoped
...
5. **Elevator queue-view reconciliation** (the `pixelart-elevator-queue-seam`
   ...
   this way).
6. **Census arrival edges** (GH #360; PR #184 defers: over-capacity arrivals eat
