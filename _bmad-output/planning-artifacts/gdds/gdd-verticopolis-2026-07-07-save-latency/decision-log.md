...
- 2026-07-08: Re-benchmarked on the player's real 12,975-unit save (towerone_6.vctower, also the reflow golden fixture). A hand-rolled schema stringifier of the same shape measured SLOWER than JSON.stringify (10.48 ms vs 7.10 ms): the cost lives in the byte volume rather than in the stringifier. Rejected.
