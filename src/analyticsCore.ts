...
/**
 * Cross-cutting props merged into EVERY event: the platform and channel
 * dimensions plus the
...
/** A copy of the boot-computed common props (platform / channel / returning /
 *  tenure / recency / display), for a surface that sends OUTSIDE the typed gameplay
