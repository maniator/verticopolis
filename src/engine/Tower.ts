...
import * as expressStops from "./tower/expressStops";
...
export class Tower {
  ...
  setExpressStops(id: number): boolean {
    return expressStops.setExpressStops(this, id);
  }

  /** Trust-boundary coercion of a loaded save's express stops to lobby-only. */
  coerceExpressStops(): void {
    expressStops.coerceExpressStops(this);
  }
