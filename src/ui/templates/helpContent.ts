...
export function helpLede(): TemplateResult {
  return html`
    ...
    <p style="color:var(--muted)">Mouse: drag to pan, scroll to zoom, click to build, Inspect tool to edit a room. With a build tool selected, hold <b>Shift</b> and drag to pan (middle or right drag, or holding Space, works too). Made a mistake? <b>Undo with Ctrl+Z</b> (or the ↩ button). Redo with Ctrl+Shift+Z. Music changes with whatever part of the tower you're viewing. Try scrolling around!</p>
  `;
}
