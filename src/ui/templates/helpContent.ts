  ...
  },
  {
    ...
    body: () => html`
      ...
      <ul>
        ...
        <li><b>Peek at a room.</b> Press and hold a room (any tool) to read its card without opening it, the way a mouse hover does. Lift to close. A quick tap still opens the full panel.</li>
