...
export function compareTemplate(): TemplateResult {
  return html`
        ...
        <ul>
          ...
          <li><b>A ready lobby.</b> A new Modern tower starts with a lobby already laid at the center of the lot. Classic starts you the way 1994 did: an empty lot, and where to lay the lobby that opens your tower is your first decision.</li>
