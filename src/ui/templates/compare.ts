...
export function compareTemplate(): TemplateResult {
  return html`
        ...
        <ul>
          ...
          <li><b>New places to build.</b> Modern adds venues the original never had: the Food Hall, a hall of food stalls that earns from foot traffic and covers a wide reach of hungry tenants, and Amusements, an arcade and games hall (classic cabinets, VR, claw machines, mini-golf) that draws teens and families and is busiest after school and on weekends. Both earn from foot traffic. Classic builds only the 1994 catalog.</li>
