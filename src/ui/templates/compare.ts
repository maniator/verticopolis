...
export function compareTemplate(): TemplateResult {
  return html`
        ...
        <ul>
          ...
          <li><b>New places to build.</b> Modern adds venues the original never had: the Food Hall (a hall of food stalls), Amusements (an arcade and games hall of classic cabinets, VR, claw machines, and mini-golf), and the Boutique Bay (a bay of small trades: florist, barber, phone repair, vintage, tattoo, record store, and gallery). All earn from foot traffic and are busier on weekends. Classic builds only the 1994 catalog.</li>
