...
export function compareTemplate(): TemplateResult {
  return html`
        ...
        <ul>
          ...
          <li><b>New places to build.</b> Modern adds venues the original never had: the Food Hall (a hall of food stalls), Amusements (an arcade and games hall of classic cabinets, VR, claw machines, and mini-golf), and the Boutique Bay (a bay of small trades: florist, barber, phone repair, vintage, tattoo, record store, and gallery). All three earn from foot traffic and are busier on weekends. There is also the Fitness Club (weight floor, yoga, spin, boxing, climbing), which instead pays a membership lease like an office and makes nearby condos a little happier, a bonus that is strongest on its own floor and fades with distance. Classic builds only the 1994 catalog.</li>
