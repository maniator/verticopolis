...
export function helpTemplate(onSplash: boolean, version: string, actions: HelpActions): TemplateResult {
  return html`
      ...
      <details class="help-modes">
        ...
        ${compareTemplate()}
        <p class="help-fullpage"><a class="btn" href="/help" target="_blank" rel="noopener noreferrer" data-act="open-help">Open the full comparison page<span class="visually-hidden"> (opens in a new tab)</span></a></p>
      </details>
      <details class="help-modes">
