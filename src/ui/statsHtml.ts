      ...
      ${
        stranded || ratingRow
          ? `<div class="col kv">${
              ...
              ratingRow
                ? `<span class="k" style="color:var(--muted);grid-column:1/-1">Hotel guests count toward your star rating up to 4★; from 5★ on, only permanent residents count. Your rating won't drop, and hotels still earn income.</span>`
                : ""
            }</div>`
          : ""
      }
